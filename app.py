...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/hcyenHW5"
## Provided:
...
def update(item):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Updated priority of item: {}'.format(item.description))
        return redirect(url_for("all_lists"))
...
def delete(lst):
    ...
    flash("Successfully deleted list {}".format(lst))
...
if __name__ == "__main__":
    ...
    #this comment is the change to HW5 to be pushed onto the new branch
